...
def argCommandline(argv):
    ...
    """
    parser = argparse.ArgumentParser(description='Check if the certificate has been generated by the PKI.')
    parser.add_argument("-c", "--cert-path", action="store", dest="certpath", type=str, help=u"Certificate path file", metavar='Common Name', required=True)
